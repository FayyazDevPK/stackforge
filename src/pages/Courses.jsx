...
const PHASES = [
  {
    id: 1, phase: "01", title: "Foundations", color: "#4FC3F7", free: true, progress: 0,
    lessons: [
      { id: "1-1", title: "How the Web Works", type: "video", duration: "18 min", done: false },
      { id: "1-2", title: "HTML5 Structure & Semantics", type: "video", duration: "24 min", done: false },
      { id: "1-3", title: "CSS3 — Selectors & Box Model", type: "video", duration: "30 min", done: false },
      { id: "1-4", title: "Flexbox & Grid Layout", type: "video", duration: "28 min", done: false },
      { id: "1-5", title: "JavaScript ES6+ Basics", type: "video", duration: "45 min", done: false },
      { id: "1-6", title: "DOM Manipulation", type: "video", duration: "32 min", done: false },
      { id: "1-7", title: "Git & GitHub Basics", type: "video", duration: "22 min", done: false },
      { id: "1-8", title: "Terminal & Command Line", type: "video", duration: "18 min", done: false },
      { id: "1-9", title: "Foundations Quiz", type: "quiz", duration: "15 min", done: false },
      { id: "1-10", title: "Responsive Design Project", type: "project", duration: "2 hrs", done: false },
      { id: "1-11", title: "Code Review & Feedback", type: "video", duration: "20 min", done: false },
      { id: "1-12", title: "Phase 1 Certificate", type: "cert", duration: "—", done: false },
    ],
  },
  {
    id: 2, phase: "02", title: "Frontend Development", color: "#81C784", free: true, progress: 0,
    lessons: [
      { id: "2-1", title: "React 18 — Components & JSX", type: "video", duration: "35 min", done: false },
      { id: "2-2", title: "Props, State & Re-rendering", type: "video", duration: "28 min", done: false },
      { id: "2-3", title: "React Hooks Deep Dive", type: "video", duration: "40 min", done: false },
      { id: "2-4", title: "useEffect & Async Patterns", type: "video", duration: "32 min", done: false },
      { id: "2-5", title: "React Router v6", type: "video", duration: "25 min", done: false },
      { id: "2-6", title: "State Management with Zustand", type: "video", duration: "30 min", done: false },
